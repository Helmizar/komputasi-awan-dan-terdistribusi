...
**Dampak ke FoodGo:** Dampaknya kerasa saat jam makan siang (saat trafik lagi tinggi). Karena tidak adanya timeout, saat modul pembayarannya merespons lambat, modul pesanan akan diam menunggu terus-terusan tanpa kepastian. Akibatnya, setiap ada pesanan masuk, antrean request makin menumpuk. Memori dan thread server pada akhirnya habis terpakai cuma buat status menunggu, sampai akhirnya server kehabisan resource dan crash total.
